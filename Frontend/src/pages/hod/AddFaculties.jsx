...
import { useCreateFacultyMutation, useDeleteFacultyMutation, useGetFacultiesQuery, useUpdateFacultyMutation } from '@/store/api/authApi';
...
const AddFaculties = () => {
   ...
   faculties = faculties.filter(faculty => faculty.role === 'Faculty' && faculty.department === user.department);
